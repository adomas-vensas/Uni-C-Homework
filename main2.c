...
//        of the 'slltool.o' module. Specifically to this program - create a list
//        full of shopping items. Also, there are two additional modules:
//        'revlist.o' and 'struct.h'. First one extends the capabilities of
//        'slltool.o' by adding the option to reverse the list. Second one - to aggregate
